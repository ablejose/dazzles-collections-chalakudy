...
export const BRAND: BrandConfig = {
  ...
  description:
    "Dazzles Collections is Chalakudy's trusted destination for exquisite gold, diamond, and silver jewellery. Serving Chalakudy and the surrounding areas with timeless craftsmanship and contemporary designs for every celebration.",
  ...
  seo: {
    ...
    description:
      "Dazzles Collections — your premier jewellery store in Chalakudy. Gold, diamond and silver jewellery crafted for every occasion. Visit us in Chalakudy, Kerala.",
    keywords: [
      "Dazzles Collections",
      "jewellery Chalakudy",
