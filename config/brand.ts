...
export const BRAND: BrandConfig = {
  ...
  description:
    "Dazzles Collections is Chalakudy's trusted destination for gold, diamond and silver jewellery. Serving Chalakudy with timeless craftsmanship and exquisite collections for every celebration.",
  ...
  seo: {
    title: "Dazzles Collections | Jewellery Store in Chalakudy",
    description:
      "Dazzles Collections — your trusted destination for gold, diamond and silver jewellery in Chalakudy, Kerala.",
    keywords: [
      "Dazzles Collections",
      "jewellery Chalakudy",
